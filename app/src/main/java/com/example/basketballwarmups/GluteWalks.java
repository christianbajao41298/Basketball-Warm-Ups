...
public class GluteWalks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glute_walks);
        //get timer data
...
//pogi
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(GluteWalks.this, WholeBodyDynamic3.class));
        finish();
    }
}