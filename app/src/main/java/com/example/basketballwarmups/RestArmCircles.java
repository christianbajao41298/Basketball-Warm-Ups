...
public class RestArmCircles extends AppCompatActivity {
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),ArmCircles.class));
                finish();
            }
        }.start();
        mTimerRunning = true;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(RestArmCircles.this, WholeBodyDynamic3.class));
