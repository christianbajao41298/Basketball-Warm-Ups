...
public class ArmStretch2 extends AppCompatActivity {
    ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_stretch2);
...
//pogi
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(), RestArmCircles.class));
            }
        }.start();
        mTimerRunning = true;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(ArmStretch2.this, WholeBodyDynamic3.class));
        finish();
    }
}