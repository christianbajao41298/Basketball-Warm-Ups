...
public class ButtKicks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_kicks);
        //get timer data
...
//pogi
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),RestWalkingHighKnees.class));
            }
        }.start();
        mTimerRunning = true;
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(ButtKicks.this, WholeBodyDynamic3.class));
        finish();
    }
}