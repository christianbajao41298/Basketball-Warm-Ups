...
public class SideSlides extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_slides);
        //get timer data
...
//pogi
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),RestLunges.class));
            }
        }.start();
        mTimerRunning = true;
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(SideSlides.this, WholeBodyDynamic3.class));
        finish();
    }
}