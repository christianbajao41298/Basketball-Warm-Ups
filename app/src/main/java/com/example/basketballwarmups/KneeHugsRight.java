...
public class KneeHugsRight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knee_hugs_right);
...
//pogi
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(KneeHugsRight.this, WholeBodyDynamic3.class));
        finish();
    }
}