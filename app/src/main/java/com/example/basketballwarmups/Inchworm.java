...
public class Inchworm extends AppCompatActivity {
...
//pogi
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),RestWalkingLungesWithRotation.class));
            }
        }.start();
        mTimerRunning = true;
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(Inchworm.this, WholeBodyDynamic3.class));
        finish();
    }
}