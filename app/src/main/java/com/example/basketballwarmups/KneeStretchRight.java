...
public class KneeStretchRight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knee_stretch_right);
        //get timer data
...
//pogi
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),RestButtKick.class));
            }
        }.start();
        mTimerRunning = true;
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        mCountDownTimer.cancel();
        startActivity(new Intent(KneeStretchRight.this, WholeBodyDynamic3.class));
        finish();
    }
}