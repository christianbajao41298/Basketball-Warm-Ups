...
public class RestKneeStretchLeft extends AppCompatActivity {
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(getApplicationContext(),KneeStretchLeft.class));
                finish();
            }
        }.start();
        mTimerRunning = true;
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(RestKneeStretchLeft.this, WholeBodyDynamic3.class));
